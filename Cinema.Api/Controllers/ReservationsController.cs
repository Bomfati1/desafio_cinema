...
public class ReservationsController : ControllerBase
{
    ...
    /// <summary>
    /// Cria uma reserva de assentos para uma sessão (requer autenticação, apenas perfil User).
    ...
    /// <response code="403">Acesso negado — administradores não podem fazer reservas.</response>
